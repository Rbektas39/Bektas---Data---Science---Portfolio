...
Users can explore K-means clustering, hierarchical clustering, and Principal Component Analysis (PCA). The app includes a built-in country development dataset, but users can also upload their own CSV files, select numeric variables, adjust hyperparameters, and view cluster summaries, dendrograms, PCA plots, explained variance, and PCA loadings.

This project highlights the difference between supervised and unsupervised learning. It focuses on pattern discovery, dimensionality reduction, and communicating model behavior in an accessible way.
...
- Interactive filtering by species, island, sex, and body mass
...
- Interactive tools that make data analysis accessible
